...
void Demo::build_secondary_cmd()
{
	...
	catEntity->Draw(cmd, pipeline_layout);
	dogEntity->Draw(cmd, pipeline_layout);
	buildingEntity->Draw(cmd, pipeline_layout);
	skyEntity->Draw(cmd, pipeline_layout);
...
void Demo::draw()
{
	...
	skyEntity->scale = glm::vec3(100.0f);
